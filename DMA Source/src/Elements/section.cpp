...
Section::Section(String measure, String name_of_data[2], String data[2])
{
    ...
    if (this->measure == Section::measuring.bpm)
        this->sensor = new Pulsemeter(A1, 10);

    if (this->measure == Section::measuring.frecuency)
...
String Section::getInfo() { return (this->name_of_data[0] + ": " + this->data[0] + " " + this->name_of_data[1] + this->data[1]); }